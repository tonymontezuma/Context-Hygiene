...
Antes de publicar no diretório de plugins: concluir avaliações conversacionais e teste de instalação nos hosts pretendidos; revisar licença e identidade do responsável; preparar descrição, identidade visual, suporte e URLs públicas exigidas pela submissão vigente. O código-fonte está no GitHub; registro em marketplace, submissão ao diretório e deploy não fazem parte desta entrega.

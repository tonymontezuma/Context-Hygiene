...
Data: 2026-09-24. Código-fonte disponibilizado no GitHub para revisão, sem instalação, publicação em diretório de plugins ou deploy.
...
Foram conferidos 15 arquivos de produto. O SKILL.md contém 532 palavras (4.176 bytes); não é uma estimativa de tokens. A contagem não inclui as referências, carregadas sob demanda. O inventário exclui metadados internos do Git.
